...
namespace InnoGotchi.Migrations
{
    ...
    [Migration("20230613152217_ChangeDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InnoGotchi.API.Core.Entities.Models.UserProfile", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InnoGotchi.API.Core.Entities.Models.Collaboration", b =>
                {
                    ...
                    b.HasOne("InnoGotchi.API.Core.Entities.Models.UserProfile", "User")
                        .WithMany("Collaborations")
            ...
            modelBuilder.Entity("InnoGotchi.API.Core.Entities.Models.Farm", b =>
                {
                    b.HasOne("InnoGotchi.API.Core.Entities.Models.UserProfile", "Owner")
                        .WithOne("Farm")
